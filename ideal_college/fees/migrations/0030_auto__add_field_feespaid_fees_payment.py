...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fees_feespaid', 'fees_payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fees.FeesPaymentHead'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'fees.feespaid': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            'fees_payment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fees.FeesPaymentHead']", 'null': 'True', 'blank': 'True'}),

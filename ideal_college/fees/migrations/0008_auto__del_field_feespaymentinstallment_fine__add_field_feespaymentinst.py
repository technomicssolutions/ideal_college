...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeesPaymentInstallment.fine'
        db.delete_column(u'fees_feespaymentinstallment', 'fine')

        # Adding field 'FeesPaymentInstallment.total_amount'
        db.add_column(u'fees_feespaymentinstallment', 'total_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'FeesPaymentInstallment.paid_fine'
        db.add_column(u'fees_feespaymentinstallment', 'paid_fine',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'FeesPayment.date'
        db.delete_column(u'fees_feespayment', 'date')

    def backwards(self, orm):
        # Adding field 'FeesPaymentInstallment.fine'
        db.add_column(u'fees_feespaymentinstallment', 'fine',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'FeesPaymentInstallment.total_amount'
        db.delete_column(u'fees_feespaymentinstallment', 'total_amount')

        # Deleting field 'FeesPaymentInstallment.paid_fine'
        db.delete_column(u'fees_feespaymentinstallment', 'paid_fine')

        # Adding field 'FeesPayment.date'
        db.add_column(u'fees_feespayment', 'date',
    ...
    models = {
        ...
        u'fees.feespaymentinstallment': {
            ...
            'paid_fine': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),

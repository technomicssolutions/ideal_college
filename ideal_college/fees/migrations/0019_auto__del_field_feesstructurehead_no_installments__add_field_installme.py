...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeesStructureHead.no_installments'
        db.delete_column(u'fees_feesstructurehead', 'no_installments')
    ...
    def backwards(self, orm):
        # Adding field 'FeesStructureHead.no_installments'
        db.add_column(u'fees_feesstructurehead', 'no_installments',

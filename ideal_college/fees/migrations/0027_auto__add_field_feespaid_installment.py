...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeesPaid.installment'
        db.add_column(u'fees_feespaid', 'installment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fees.Installment'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FeesPaid.installment'
        db.delete_column(u'fees_feespaid', 'installment_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeesPaymentHead.fine'
        db.add_column(u'fees_feespaymenthead', 'fine',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FeesPaymentHead.fine'
        db.delete_column(u'fees_feespaymenthead', 'fine')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FeesPaymentHead'
        db.create_table(u'fees_feespaymenthead', (
            ...
            ('fees_head', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fees.FeesStructureHead'], null=True, blank=True)),
        ))
        db.send_create_signal(u'fees', ['FeesPaymentHead'])

        # Removing M2M table for field payment_installment on 'FeesPayment'
        db.delete_table('fees_feespayment_payment_installment')

        # Adding M2M table for field payment_heads on 'FeesPayment'
        db.create_table(u'fees_feespayment_payment_heads', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feespayment', models.ForeignKey(orm[u'fees.feespayment'], null=False)),
            ('feespaymenthead', models.ForeignKey(orm[u'fees.feespaymenthead'], null=False))
        ))
        db.create_unique(u'fees_feespayment_payment_heads', ['feespayment_id', 'feespaymenthead_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FeesPaymentHead'
        db.delete_table(u'fees_feespaymenthead')
        ...
        # Removing M2M table for field payment_heads on 'FeesPayment'
        db.delete_table('fees_feespayment_payment_heads')

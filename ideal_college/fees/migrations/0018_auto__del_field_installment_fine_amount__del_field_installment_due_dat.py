...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Installment.fine_amount'
        db.delete_column(u'fees_installment', 'fine_amount')

        # Deleting field 'Installment.due_date'
        db.delete_column(u'fees_installment', 'due_date')

        # Deleting field 'Installment.amount'
        db.delete_column(u'fees_installment', 'amount')

        # Adding field 'Installment.name'
        db.add_column(u'fees_installment', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Installment.start_date'
        db.add_column(u'fees_installment', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Installment.end_date'
        db.add_column(u'fees_installment', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Installment.fine_amount'
        db.add_column(u'fees_installment', 'fine_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Installment.due_date'
        db.add_column(u'fees_installment', 'due_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Installment.amount'
        db.add_column(u'fees_installment', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Installment.name'
        db.delete_column(u'fees_installment', 'name')

        # Deleting field 'Installment.start_date'
        db.delete_column(u'fees_installment', 'start_date')

        # Deleting field 'Installment.end_date'
        db.delete_column(u'fees_installment', 'end_date')

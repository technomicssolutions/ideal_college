...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CourseBranch', fields ['branch']
        db.create_unique(u'college_coursebranch', ['branch'])

    def backwards(self, orm):
        # Removing unique constraint on 'CourseBranch', fields ['branch']
        db.delete_unique(u'college_coursebranch', ['branch'])
    ...
    models = {
        ...
        u'college.coursebranch': {
            ...
            'branch': ('django.db.models.fields.CharField', [], {'max_length': '200', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'college_course', 'university',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['college.University'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Course.university'
        db.delete_column(u'college_course', 'university_id')
    ...
    models = {
        ...
        u'college.course': {
            ...
            'university': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['college.University']", 'null': 'True', 'blank': 'True'})
        },

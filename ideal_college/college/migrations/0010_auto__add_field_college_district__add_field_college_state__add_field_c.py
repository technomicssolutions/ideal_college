...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'College.district'
        db.add_column(u'college_college', 'district',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'College.state'
        db.add_column(u'college_college', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'College.PIN'
        db.add_column(u'college_college', 'PIN',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'College.contact'
        db.add_column(u'college_college', 'contact',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'College.district'
        db.delete_column(u'college_college', 'district')

        # Deleting field 'College.state'
        db.delete_column(u'college_college', 'state')

        # Deleting field 'College.PIN'
        db.delete_column(u'college_college', 'PIN')

        # Deleting field 'College.contact'
        db.delete_column(u'college_college', 'contact')

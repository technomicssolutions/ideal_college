...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Course', fields ['course']
        db.delete_unique(u'college_course', ['course'])

    def backwards(self, orm):
        # Adding unique constraint on 'Course', fields ['course']
        db.create_unique(u'college_course', ['course'])

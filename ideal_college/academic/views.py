    ...
    def get(self, request, *args, **kwargs):
        ...
        if not report_type:
            ...
            if tc_type == 'type1':
                ...
                p.drawString(365, y - 125, ('SELF FINANCING'))
                p.setFont('Helvetica',12)
                ...
                p.drawString(300, y - 185, (student.dob.strftime('%d-%m-%Y')))

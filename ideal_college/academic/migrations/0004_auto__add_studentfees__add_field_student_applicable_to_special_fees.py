...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentFees'
        db.create_table(u'academic_studentfees', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feeshead', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fees.FeesStructureHead'], null=True, blank=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2)),
        ))
        db.send_create_signal(u'academic', ['StudentFees'])

        # Adding field 'Student.applicable_to_special_fees'
        db.add_column(u'academic_student', 'applicable_to_special_fees',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field student_fees on 'Student'
        db.create_table(u'academic_student_student_fees', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm[u'academic.student'], null=False)),
            ('studentfees', models.ForeignKey(orm[u'academic.studentfees'], null=False))
        ))
        db.create_unique(u'academic_student_student_fees', ['student_id', 'studentfees_id'])

    def backwards(self, orm):
        # Deleting model 'StudentFees'
        db.delete_table(u'academic_studentfees')

        # Deleting field 'Student.applicable_to_special_fees'
        db.delete_column(u'academic_student', 'applicable_to_special_fees')

        # Removing M2M table for field student_fees on 'Student'
        db.delete_table('academic_student_student_fees')
    ...
    models = {
        u'academic.student': {
            ...
            'applicable_to_special_fees': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'student_fees': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['academic.StudentFees']", 'null': 'True', 'blank': 'True'}),
        ...
        u'academic.studentfees': {
            'Meta': {'object_name': 'StudentFees'},
            'amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            'feeshead': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fees.FeesStructureHead']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'college.batch': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Staff.staff_name'
        db.delete_column(u'staff_staff', 'staff_name')

        # Deleting field 'Staff.email'
        db.delete_column(u'staff_staff', 'email')

        # Adding field 'Staff.user'
        db.add_column(u'staff_staff', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Staff.staff_name'
        db.add_column(u'staff_staff', 'staff_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.email'
        db.add_column(u'staff_staff', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Staff.user'
        db.delete_column(u'staff_staff', 'user_id')
